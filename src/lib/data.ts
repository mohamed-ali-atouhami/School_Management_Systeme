...
export const calendarEvents = [
  ...
  },
  {
    ...
    end: new Date(2025, 2, 3, 10, 45),
  },
  {
    title: "Physics",
    allDay: false,
    start: new Date(2025, 2, 3, 11, 0),
    end: new Date(2025, 2, 3, 11, 45),
  },
  {
    title: "Chemistry",
    allDay: false,
  ...
  },
  {
    ...
    end: new Date(2025, 2, 3, 14, 45),
  },
  {
    title: "English",
    allDay: false,
    start: new Date(2025, 2, 4, 9, 0),
    end: new Date(2025, 2, 4, 9, 45),
  },
  {
    title: "Biology",
    allDay: false,
    start: new Date(2025, 2, 4, 10, 0),
    end: new Date(2025, 2, 4, 10, 45),
  },
  {
    title: "Physics",
    allDay: false,
    start: new Date(2025, 2, 4, 11, 0),
    end: new Date(2025, 2, 4, 11, 45),
  },
  {
    title: "History",
    allDay: false,
    start: new Date(2025, 2, 4, 14, 0),
    end: new Date(2025, 2, 4, 14, 45),
  },
  {
    title: "Math",
    allDay: false,
    start: new Date(2025, 2, 5, 8, 0),
    end: new Date(2025, 2, 5, 8, 45),
  },
  {
    title: "Biology",
    allDay: false,
    start: new Date(2025, 2, 5, 10, 0),
    end: new Date(2025, 2, 5, 10, 45),
  },
  {
    title: "Chemistry",
    allDay: false,
    start: new Date(2025, 2, 5, 13, 0),
    end: new Date(2025, 2, 5, 13, 45),
  },
  {
    title: "History",
    allDay: false,
    start: new Date(2025, 2, 5, 14, 0),
    end: new Date(2025, 2, 5, 14, 45),
  },
  {
    title: "English",
    allDay: false,
  ...
  },
  {
    ...
    end: new Date(2025, 2, 6, 11, 45),
  },
  {
    title: "History",
    allDay: false,
    start: new Date(2025, 2, 6, 14, 0),
    end: new Date(2025, 2, 6, 14, 45),
  },
  {
    title: "Math",
    allDay: false,
