...
export const teacherSchema = z.object({
  ...
  bloodType: z.enum(["A_PLUS", "A_MINUS", "B_PLUS", "B_MINUS", "AB_PLUS", "AB_MINUS", "O_PLUS", "O_MINUS"], { message: "Blood Type is required!" }),
...
export const resultSchema = z.object({
  id: z.coerce.number().optional(),
  score: z.coerce.string().min(1, { message: "Score is required!" }),
...
export const attendanceSchema = z.object({
  ...
  present: z.enum(["true", "false"], { message: "Present is required!" }),
  studentId: z.coerce.string({ message: "Student is required!" }),
  lessonId: z.coerce.number({ message: "Lesson is required!" }),
});
